...
public class Checkouts {
    ...
    public Checkouts(int id, int idbook, String dateoftake,String dateofretrieve) {
        this.id = id;
        this.idbook=idbook;
    ...
    public Checkouts(int id, String dateoftake,String dateofretrieve) {
        this.id = id;
        this.dateoftake=dateoftake;
        this.dateofretrieve=dateofretrieve;
        //return this;
  ...
  *
    ...
    public Checkouts idbook(Integer idbook) {
        this.idbook = idbook;
        return this;
    }
  ...
  *
    ...
    public Checkouts dateoftake(String dateoftake) {
        this.dateoftake = dateoftake;
        return this;
    }
  ...
  *
    ...
    public Checkouts dateofretrieve(String dateofretrieve) {
        this.dateofretrieve = dateofretrieve;
        return this;
    }
